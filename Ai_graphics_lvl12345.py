...
class GUI(TicTacToe):
    ...
    def menu_click(self,i):
        ...
        if self.board.opponent == "Test Run":
            messagebox.showinfo("Instruction", self.board.opponent+" checks whether 2 ai bots run fine in which case match should end in draw!")
